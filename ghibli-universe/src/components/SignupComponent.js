...
class SignupComponent extends Component{
  ...
  render() {
    ...
    //   </div>
    // </div>
<div style={{ background:'linear-gradient(90deg, #3c3b3f 0%,#605c3c 100% )', fontFamily: 'Times New Roman'}}>
  ...
  <div class="row">
    ...
    <div class="col">
       ...
       <div style={{textAlign:'right'}}>
           ...
           <NavLink to= './LoginComponent'><button className="btn btn-success"  style={{ margin:'10px',backgroundColor: '#2b250f', color: '#cccdb4',display:'inline-block'}}>LOGIN </button></NavLink>
          <NavLink to= './'><button className="btn btn-success" style={{backgroundColor: '#2b250f', color: '#cccdb4', display:'inline-block'}} > SIGNUP</button></NavLink>
